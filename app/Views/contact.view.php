    ...
    <div class="row gx-4 gx-lg-5 align-items-center my-5">
        ...
        <div class="col-lg-5">
            ...
            <p>Nurse in retraining, I have been coding since 2019, I have gone through various training
                organizations to improve my skills. Notably <a class="text-secondary" href="https://www.studi.com/fr/formation/developpement/bachelor-developpeur-dapplication-java-0">Study</a>
                and <a class="text-secondary" href="https://openclassrooms.com/fr/paths/500-developpeur-dapplication-php-symfony">Openclassrooms</a>.
    ...
    <div class="row gx-4 gx-lg-5">
        ...
        <div class="d-flex col-md-4 mb-5 justify-content-center">
            <div class="card d-flex column shadow" style="width: 18rem;">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="card-img-top bi bi-telephone-fill my-5" viewBox="0 0 16 16">
        ...
        <div class="d-flex col-md-4 mb-5 justify-content-center">
            <div class="card d-flex column shadow" style="width: 18rem;">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class=" card-img-top bi bi-geo-alt-fill my-5" viewBox="0 0 16 16">
        ...
        <div class="d-flex col-md-4 mb-5 justify-content-center">
            <div class=" card d-flex column shadow" style="width: 18rem;">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="card-img-top bi bi-envelope-fill my-5" viewBox="0 0 16 16">
